...
public class SetOfNaturalsTest {
    ...
    //Add duplicate value -> IllegalArgumentException
    @Test
    public void testAddDuplicate() {
        assertThrows(IllegalArgumentException.class, () -> setB.add(30)); //30 is already there
    }

    //size needs to be 2
    @Test
    public void testSize() {
        assertNotEquals(2, setA.size());
    }

    //set can't be created with an array that contains duplicates
    @Test
    public void testNewSetFromArray() {
        int[] elementArray = {10,20,30,10};
        assertThrows(IllegalArgumentException.class, () -> setA.fromArray(elementArray));
    }
