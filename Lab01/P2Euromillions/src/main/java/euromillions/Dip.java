...
public class Dip {
    ...
    final static int numberlimit = 49;
    final static int starlimit = 9;
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < maxstars; ) {
            int candidate = generator.nextInt(starlimit) + 1;
    ...
    public String format() {
        ...
        for (int star : getStarsColl()) {
            sb.append(String.format("%3d", star)); //antes estavas %d, ao mudar para %3d apanha tudo menos o ultimo caracter ]
        }
        sb.append("]"); //caracter em falta para o teste passar
        return sb.toString();
    }
}
